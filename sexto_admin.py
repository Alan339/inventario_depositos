...
def v_sexto():
	...
	tabla=ttk.Treeview(tabla_frame,yscrollcommand=scroll.set,height=10,show="headings",columns=('#1','#2','#3','#4','#5','#6','#7'),selectmode="none")
