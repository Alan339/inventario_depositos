...
raiz.title("Modificar monitores")
...
cuadroMonitor=Entry(miFrame)
cuadroMonitor.grid(row=5, column=1, columnspan=2, padx=10)
cuadroMonitor.config(justify="center")
...
cuadroObservaciones.grid(row=9, column=2, pady=10)
cuadroObservaciones.config(justify="center")

cuadroRecomendaciones=Entry(miFrame)
cuadroRecomendaciones.grid(row=11, column=2, pady=10)
...
tabla=ttk.Treeview(miFrame3,yscrollcommand=scroll.set,height=5,show="headings",columns=('#1','#2','#3','#4','#5'))
