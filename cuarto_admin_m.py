...
def v_cuarto():
	...
	def llenar_tabla():
		...
		instruccion="SELECT * FROM cuarto"
	...
	Label(frame, text="Cuarto",font=("Calibri",12,"bold")).grid(row=1,column=0,padx=5,pady=2)
	...
	def boton3():
		...
		instruccion="UPDATE cuarto SET NOMBRES=%s, APELLIDOS=%s, DNI=%s, MATERIAS_ADEUDADAS=%s, FECHA_INGRESO=%s, OBSERVACION=%s WHERE ID="+registro
	...
	frame2=LabelFrame(root,text="Curso de cuarto:")
	frame2.pack()
