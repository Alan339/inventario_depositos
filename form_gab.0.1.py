...
cuadroMonitor=Entry(miFrame)
cuadroMonitor.grid(row=3, column=1, columnspan=2, padx=10, pady=10)
cuadroMonitor.config(justify="center")

cuadroModelo=Entry(miFrame)
cuadroModelo.grid(row=3, column=2, columnspan=3, padx=10, pady=5)
cuadroModelo.config(justify="center")

cuadroCheck=Checkbutton(miFrame)
cuadroCheck.grid(row=5, column=2, pady=5)
...
MarcaLabel.grid(row=2, column=1, columnspan=2)
