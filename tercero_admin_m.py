...
def v_tercero():
	...
	def boton3():
		...
		instruccion="UPDATE tercero SET NOMBRES=%s, APELLIDOS=%s, DNI=%s, MATERIAS_ADEUDADAS=%s, FECHA_INGRESO=%s, OBSERVACION=%s WHERE ID="+registro
