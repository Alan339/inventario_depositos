...
raiz.title("Modificar tablas de gabinetes")
...
cuadroMonitor=Entry(miFrame)
cuadroMonitor.grid(row=5, column=1, columnspan=2, padx=10, pady=10)
cuadroMonitor.config(justify="center")

cuadroModelo=Entry(miFrame)
cuadroModelo.grid(row=5, column=2, columnspan=3, padx=10, pady=5)
...
ModeloLabel=Label(miFrame, text="OS:")
...
tabla.column('#4',width=40)
tabla.heading('#4',text="Marca",anchor=CENTER)
tabla.column('#5',width=40)
tabla.heading('#5',text="OS",anchor=CENTER)
