...
def v_segundo():
	...
	tabla=ttk.Treeview(frame2,yscrollcommand=scroll.set,height=10,show="headings",columns=('#1','#2','#3','#4','#5','#6','#7'),selectmode="none")
