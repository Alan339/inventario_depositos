...
def v_quinto():
	...
	def llenar_tabla():
		...
		instruccion="SELECT * FROM quinto"
	...
	Label(frame, text="Quinto",font=("Calibri",12,"bold")).grid(row=1,column=0,padx=5,pady=2)
	...
	def boton3():
		...
		instruccion="UPDATE quinto SET NOMBRES=%s, APELLIDOS=%s, DNI=%s, MATERIAS_ADEUDADAS=%s, FECHA_INGRESO=%s, OBSERVACION=%s WHERE ID="+registro
	...
	frame2=LabelFrame(root,text="Curso de quinto:")
	frame2.pack()
